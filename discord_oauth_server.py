...
# facultatif si tu veux filtrer par serveur
...
def post_with_rate_limit(url, data=None, headers=None, max_attempts=3):
...
def callback():
    ...
    token_response = post_with_rate_limit(
        DISCORD_TOKEN_URL,
        data=token_payload,
    ...
    if token_response.status_code == 429:
        return "Discord is rate limiting requests right now. Wait 1-2 minutes and try again.", 429
